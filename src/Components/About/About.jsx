...
const About = forwardRef((props, ref) => {
  ...
  return (
    <div
      ref={ref}
      className="relative  w-screen min-h-screen flex flex-col justify-center items-center  gap-5"
    >
      <div className="w-[95%] sm:w-[90%] xl:w-250 flex justify-start items-center">
        <div className="w-full flex justify-start items-center text-gray-400 font-bold font-[Roboto] normal-case text-4xl">
          <GradientText
            colors={["#40ffaa", "#7479ff", "#40ffaa", "#4079ff", "#40ffaa"]}
            animationSpeed={3}
          >
            About Me
          </GradientText>
      ...
      <div className="w-[95%] sm:w-[90%] xl:w-250 flex flex-wrap justify-start items-start gap-5">
        ...
        >
          ...
          scalable, responsive web applications using Next.js, React.js, Express.js, Node.js, TypeScript, JavaScript and MongoDB. I specialize in clean UI design with Tailwind CSS
        ...
        <div className="h-50 w-auto flex flex-col justify-start items-start gap-5">
          <div className="font-[Anton] text-4xl text-gray-400 w-full   ">
            Social Links
          </div>
          <div className=" w-full flex justify-start items-center gap-5 mb-4">
            <motion.a
              ...
              target="_blank"
              className="cursor-pointer border-2 rounded-[50%] hover:bg-purple-800 transition-all"
            >
              <img src={githublogo} loading="eager" alt="github" />
            </motion.a>
            <motion.a
              initial={{ opacity: 0, y: 50 }}
              whileInView={{
              ...
              viewport={{ once: false, amount: 0.5 }}
              aria-label="linkedin"
              href="https://www.linkedin.com/in/vishalvishwas/"
              target="_blank"
              className="cursor-pointer border-2 rounded-[50%] hover:bg-blue-800 transition-all p-[2px]"
            >
              <img src={linkedin} loading="eager" alt="linkedin" />
            </motion.a>
            <motion.a
              initial={{ opacity: 0, y: 50 }}
              whileInView={{
              ...
              viewport={{ once: false, amount: 0.5 }}
              aria-label="twitter"
              href="https://x.com/vishalvishwas01"
              target="_blank"
              className="cursor-pointer border-2 rounded-[50%] hover:bg-gray-800 transition-all p-[2px]"
            >
              <img src={twitter} loading="eager" alt="twitter" />
            </motion.a>
          </div>

          <div className="font-[Anton] text-4xl text-gray-400 w-full flex ">
            Email{" "}
            <motion.span
              initial={{ opacity: 0, y: 50 }}
              whileInView={{
              ...
              viewport={{ once: false, amount: 0.5 }}
              className="font-[Roboto] text-[16px] flex sm:hidden justify-center items-center text-white ml-2"
            >
              {" "}
              vishalvishwas7082@gmail.com
              <Copy />
            </motion.span>
          </div>
          <motion.div
            ...
            viewport={{ once: false, amount: 0.5 }}
            className="font-[Roboto] text-xl sm:text-2xl hidden sm:flex justify-start items-center text-white"
          >
            vishalvishwas7082@gmail.com
            <Copy />
          </motion.div>
